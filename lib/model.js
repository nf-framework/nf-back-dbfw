...
class Model {
    ...
    static buildSelect(queryOptions, params = {}, { as } = {}) {
        ...
        let attributes = '*';
        const alias = (as) || `${this.constructor._def.schema}__${this.constructor._def.table}`;
        ...
        for (const _inc of include) {
            const inc = Model.incResolve.call(this, _inc);
            const qOptions = { ..._inc.queryOptions, whereSubQuery: { [inc.fk]: `${alias}.${this.constructor._def.pk || 'id'}` } };
        ...
        sql += ` from ${this.constructor._def.schema}.${this.constructor._def.view} as ${alias}`;
